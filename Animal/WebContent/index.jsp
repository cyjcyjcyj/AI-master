...
<body>
	...
	<div id="beginbtn">开始推理</div>	
	<div class="container">
		<div class="navbar-header" >
			<button style="display:none" class="navbar-toggle collapsed" type="button"
		...
		<div id="navbar" class="navbar-collapse collapse navbar-left">
			<ul class="nav navbar-nav">
						...
						<li><a href="#" id="addrule_btn">add rules</a></li>
						<li><a href="#" id="delete_btn">delete rules</a></li>
					</ul>
			</ul>
		</div>
	</div>
	...
	<div class="" id="addrule" style="display:none;">
		<form id="addrule_par" action="">
				...
				<label>新加特征：</label><input style="width:300px;padding-left:20px" type="text" name="" id="conditions" value="" />
				</div>
				<div style="padding-left:20px">
				<label>得到结果：</label><input style="width:300px;padding-left:20px" type="text" name="" id="result" value="" />
				</div>
				
				<div style="padding-left:20px">
				<label>是否可以推出具体动物：</label>
				<select id="can_end">
	...
	<div class="list">
		...
		<div class="row task-panel">
			...
			<div class="col-sm-5 tasklist tasklistleft" >
